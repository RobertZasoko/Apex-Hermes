...
export const ProblemUserIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
  </svg>
);

export const ProblemCalendarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M-4.5 12h21.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 12.75l-4.5 4.5m0-4.5l4.5 4.5" />
  </svg>
);

export const ProblemDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a6 6 0 006 0v-1.5m-6 0v-1.5m6 1.5v-1.5m6 1.5a6 6 0 00-6 0v-1.5m6 0v-1.5m-6 0a6 6 0 00-6 0v-1.5m6 0a6 6 0 006 0v-1.5m0 9a6 6 0 00-6 0v-1.5m6 0v-1.5m0 0a6 6 0 00-6 0v-1.5m-6 0a6 6 0 006 0v-1.5m-6 0a6 6 0 006 0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25l-2.25 2.25m0 0l2.25 2.25M9.75 10.5h4.5m-4.5 3h4.5m-1.5-6.75v10.5" />
  </svg>
);
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
    <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039L38.804 9.81C34.553 5.806 29.613 3.5 24 3.5C11.9 3.5 1.5 13.9 1.5 26S11.9 48.5 24 48.5c12.1 0 22.5-10.4 22.5-22.5c0-1.38-.15-2.73-.389-4.083z" />
